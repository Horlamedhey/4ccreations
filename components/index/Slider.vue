...
<div style="position:relative; height:100vh;" id="slider" v-if="component === 'Home' && sliderHeight === 90">
  ...
  <v-layout justify-center wrap style="align-content: center; position: absolute; top:0; width:100%; height:100%; background:rgba(0,0,0,0.7);">
            <v-flex xs12 md10 class="mt-5">
              <no-ssr>
	            <vue-typer style="font-size: 6.8vw; letter-spacing: 0.5vw; color: #ffffff;" :text='["Build IT!","Build your career!"]' :repeat='Infinity' :shuffle='false' initial-action='typing'
            ...
            <v-flex align-content-center xs12 md10 style="font-size: 3vw; text-align:center" class="white--text">
